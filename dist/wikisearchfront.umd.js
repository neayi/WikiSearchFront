...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"6527fc02-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=48a0429a&
...
// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=48a0429a&
    ...
    doApiCall: function doApiCall(_ref11, _ref12) {
      ...
      api.post(actions.params).done(function (data) {
        ...
        if (!actions.component) {
          var _data$result$total;

          commit('SET_FROM_API', {
            hits: JSON.parse(data.result.hits),
            total: (_data$result$total = data.result.total) !== null && _data$result$total !== void 0 && _data$result$total.value ? data.result.total.value : data.result.total,
...
var Resultsvue_type_template_id_0a0941b4_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"wikisearch-result",class:_vm.config.settings.layout
  ...
  methods: {
    ...
    href: function href(prop) {
      ...
      if (this.label === '$title' && this.config.display !== 'pdflink') {
        ...
        return "".concat(this.articlePath, "/").concat(ns).concat(page).concat(urlString);
      }

      if (this.config.display === 'pdflink') {
        var snippet = this.$store.state.term ? "&snippet=".concat(encodeURIComponent(this.$store.state.term)) : '';
        return "".concat(this.articlePath, "/Pdf_viewer?pdf=").concat(encodeURIComponent(title.replaceAll(' ', '_'))).concat(snippet);
      }
...
var ResultProperty_component = normalizeComponent(
  ...
  ResultPropertyvue_type_template_id_214a6061_render,
  ResultPropertyvue_type_template_id_214a6061_staticRenderFns,
  false,
  null,
  null,
  null
  ...
  methods: {
    getHref: function getHref(hit) {
      ...
      if (this.config.settings.title.display === 'pdflink' || this.config.hitSettings.$title && this.config.hitSettings.$title.display === 'pdflink') {
        var snippet = this.$store.state.term ? "&snippet=".concat(encodeURIComponent(this.$store.state.term)) : '';
        return "".concat(this.articlePath, "/Pdf_viewer?pdf=").concat(encodeURIComponent(hit[source].subject.title.replaceAll(' ', '_'))).concat(snippet);
      }

      return hit[source] && hit[source]["P:".concat(titleSettings.key)] && hit[source]["P:".concat(titleSettings.key)][titleSettings.type] && hit[source]["P:".concat(titleSettings.key)][titleSettings.type][0] ? hit[source]["P:".concat(titleSettings.key)][titleSettings.type][0] : hit[source].subject.title;
    }
  }
});
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"6527fc02-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/filters/FacetFilter.vue?vue&type=template&id=67ec578b&
var FacetFiltervue_type_template_id_67ec578b_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{class:("wikisearch-filter wikisearch-filter--" + (_vm.strip(_vm.name))),attrs:{"role":"group","aria-labelledby":("filter__label--" + (_vm.strip(_vm.name)))}},[(_vm.strippedBuckets.length || _vm.type === 'date')?_c('span',{staticClass:"wikisearch-filter__label"},[_c('label',{attrs:{"id":("filter__label--" + (_vm.strip(_vm.name)))}},[_vm._v(" "+_vm._s(_vm.cleanName)+" ")])]):_vm._e(),_c('div',{staticClass:"wikisearch-filter__options"},[_vm._l((_vm.bucketsToShow),function(agg,i){return _c('facet-checkbox',{directives:[{name:"show",rawName:"v-show",value:(i < _vm.collapsed || _vm.open),expression:"i < collapsed || open"}],key:i + agg.key + _vm.name,attrs:{"agg":agg,"index":i,"name":_vm.name}})}),(_vm.type === 'date')?_c('div',{staticClass:"wikisearch-filter__custom-date"},[_c('facet-checkbox',{attrs:{"agg":{
          'from': _vm.createDate(_vm.customDates.from),
          'to': _vm.createDate(_vm.customDates.to),
          'doc_count': 4,
          'key': 'customrange',
          'name': _vm.customDateRangeLabel
        },"index":999,"name":_vm.name}}),_c('div',{staticClass:"wikisearch-date-input-container"},[_c('wikisearch-date-input',{attrs:{"disabled-direction":"before","disabled-date":_vm.customDates.to,"value":_vm.customDates.from},on:{"change":function($event){return _vm.setCustomDate($event, 'from')}}}),_c('wikisearch-date-input',{attrs:{"disabled-direction":"after","disabled-date":_vm.customDates.from,"value":_vm.customDates.to},on:{"change":function($event){return _vm.setCustomDate($event, 'to')}}})],1)],1):_vm._e(),(_vm.strippedBuckets.length > _vm.collapsed)?_c('wikisearch-button',{staticClass:"wikisearch-filter__button",attrs:{"icon":_vm.open ? 'up' : 'down',"label":_vm.$i18n(("wikisearchfront-" + _vm.lessOrMore))},on:{"click":function($event){_vm.open = !_vm.open}}}):_vm._e()],2)])}
var FacetFiltervue_type_template_id_67ec578b_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/filters/FacetFilter.vue?vue&type=template&id=67ec578b&
        ...
        var selectedUpdated = selected.map(function (item) {
          return item.key === _this2.name ? {
            ...
            range: {
              ...
              lte: _this2.createDate(window.moment(_this2.customDates.to).add(1, 'days').format('YYYY-MM-DD'))
            },
            value: 'customrange',
    ...
    organize: function organize() {
      ...
      if (this.type === 'date') {
        ...
        this.strippedBuckets = organizedBuckets.sort(function (a, b) {
          var textA = a.key_as_string ? a.key_as_string.toUpperCase() : a.key.toUpperCase();
          var textB = b.key_as_string ? b.key_as_string.toUpperCase() : b.key.toUpperCase(); // eslint-disable-next-line no-nested-ternary
        ...
        this.strippedBuckets = organizedBuckets.sort(function (a, b) {
          var textA = a.key_as_string ? a.key_as_string.toUpperCase() : a.key.toUpperCase();
          var textB = b.key_as_string ? b.key_as_string.toUpperCase() : b.key.toUpperCase();
...
var FacetFilter_component = normalizeComponent(
  ...
  FacetFiltervue_type_template_id_67ec578b_render,
  FacetFiltervue_type_template_id_67ec578b_staticRenderFns,
  false,
  null,
  null,
  null
    ...
    doAction: function doAction() {
      if (this.state.selectedResults.length) {
        if (this.settings.action.type === 'page') {
          ...
          window.location = "".concat(window.location.origin, "/").concat(this.settings.action.name).concat(params);
        } else {
